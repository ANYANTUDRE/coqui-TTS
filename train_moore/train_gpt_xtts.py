...
from moore_training_utils import MooreGPTTrainer, moore_dataset_formatter

# Logging parameters
RUN_NAME = "RUN_GPT_XTTS_v2.0_MOS_FT_2"
...
CHECKPOINTS_OUT_PATH = os.path.join(OUT_PATH, "CHECKPOINT_GPT_XTTS_v2.0_MOS_FT_2/")
...
TOKENIZER_FILE = "/teamspace/studios/this_studio/coqui-TTS/train_moore/saved/combined_vocab.json"  # vocab.json file
...
def main():
    ...
    model = MooreGPTTrainer.init_from_config(config)
